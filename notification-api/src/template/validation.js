...
const registerTemplateSchema = Joi.object({
  service: Joi.string().trim().valid('slack', 'sms', 'email', 'whatsapp').required(),
  ...
  templateId: Joi.string()
    ...
    .messages({
      'string.pattern.base': 'templateId can contain only letters, numbers, _ and - without spaces',
    ...
    .items(
      Joi.object({
        ...
        constraints: Joi.object({
          ...
          dataType: Joi.string().valid('string', 'integer', 'number').optional().messages({
